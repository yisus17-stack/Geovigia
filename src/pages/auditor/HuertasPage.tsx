...
function HuertasPage() {
  ...
  return <AppLayout>
    <header className="page-header"><div><p className="eyebrow">Auditoría / Huertas</p><h1>Huertas registradas</h1><p>Encuentra el predio, revisa qué le falta y continúa con su evidencia o auditoría.</p></div><Link className="button" to="/auditor/huertas/nuevo">+ Registrar huerta</Link></header>
